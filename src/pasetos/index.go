...
func (maker *PasetoMaker) CreateToken(data *Data, duration time.Duration) (string, httperrors.HttpErr) {
	...
	if err != nil {
		return "", httperrors.NewBadRequestError(fmt.Sprintf("something went Paseto Encryption, %d", errs))
	}
	return str, nil
}
